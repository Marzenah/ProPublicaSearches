...
def main():
    ...
    window = Tk()   # this is the container for the GUI
...
class GuiApp():
    ...
    def __init__(self, parentWindow, topFramePic):
        ...
        rd1 = Radiobutton(self.window,text='1: Get the list of Congressional reps for a given state ->', variable=self.choice_var, value=1)
        rd1.grid(row=2, column=0, padx=8, pady=18, sticky=W)

        label1_search1 = Label(self.window, text="Enter the state's two-letter code:   ")
        ...
        rd2.grid(row=3, column=0, padx=8, pady=5, sticky=W)

        label1_search2 = Label(self.window, text="Enter rep's last name:   ")
        ...
        label2_search2 = Label(self.window, text="Enter rep's first name:   ")
        ...
        rd3 = Radiobutton(self.window, text='3: Get graph for historical data on average age in Congress', variable=self.choice_var, value=3)
        rd3.grid(row=6, column=0, padx=8, sticky=W)
